...
public class CANSpeedControllerBuilder {
	...
	public static CustomTalonSRX createMasterTalonSRX(int id, int pdpChannel) {
		Configuration masterConfig = new Configuration();
	...
	public static CustomTalonSRX createFastMasterTalonSRX(int id, int pdpChannel) {
		Configuration masterConfig = new Configuration();
		masterConfig.CONTROL_FRAME_PERIOD_MS = 5;
		masterConfig.STATUS_FRAME_GENERAL_1_MS = 5;
		return createTalonSRX(id, pdpChannel, masterConfig);
	...
	public static CustomTalonSRX createPermanentSlaveTalonSRX(int id, int pdpChannel, TalonSRX masterTalon) {
		CustomTalonSRX talon = createTalonSRX(id, pdpChannel, kSlaveConfiguration);
		talon.follow(masterTalon);
		return talon;
	}
	...
	public static CustomTalonSRX createTalonSRX(int id, int pdpChannel, Configuration config) {
