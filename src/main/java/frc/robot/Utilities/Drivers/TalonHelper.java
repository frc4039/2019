...
public class TalonHelper {
	...
	public static boolean setPIDGains(CustomTalonSRX talon, int slotID, double kP, double kI, double kD, double kF, double rampRate, int iZone) {
		return setPIDGains(talon, slotID, kP, kI, kD, kF, rampRate, iZone, Constants.kTimeoutMs);
	}
	public static boolean setPIDGains(CustomTalonSRX talon, int slotID, double kP, double kI, double kD, double kF, double rampRate, int iZone, int timeout) {
		boolean setSucceeded = setPIDGains(talon, slotID, kP, kI, kD, kF, timeout);
		int retryCounter = 0;
	...
	public static boolean setMotionMagicParams(CustomTalonSRX talon, int slotIdx, int cruiseVelocityRPM, int maxAccelRPM) {
		return setMotionMagicParams(talon, slotIdx, cruiseVelocityRPM, maxAccelRPM, Constants.kTimeoutMs);
	}
	public static boolean setMotionMagicParams(CustomTalonSRX talon, int slotIdx, int cruiseVelocityRPM, int maxAccelRPM, int timeout) {
		boolean setSucceeded = true;
		int retryCounter = 0;
		if (timeout > 0) {
			do {
